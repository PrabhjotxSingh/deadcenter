...
export class Gun {
  ...
  private updateDebugUI() {
    ...
    this.debugEl.innerHTML = `
      ...
      Z: ${p.z.toFixed(3)} ← ArrowUp / ArrowDown<br>
      <br>
      <b>Rotation</b><br>
      X: ${r.x.toFixed(3)} ← I / K<br>
      Y: ${r.y.toFixed(3)} ← J / L<br>
      Z: ${r.z.toFixed(3)} ← U / O<br>
      <br>
      <b>Scale</b><br>
      ${s.toFixed(3)} ← + / -<br>
      <br>
      <b>Copy this into Gun.ts:</b><br>
  ...
  fire() {
    if (this.currentState === "fire") return;
  ...
  reload() {
    if (this.currentState === "fire" || this.currentState === "reload") return;
